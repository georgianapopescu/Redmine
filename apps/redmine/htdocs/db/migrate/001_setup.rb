...
class Setup < ActiveRecord::Migration
  ...
  def self.up
    ...
    user = User.new :firstname => "Georgiana",
                    :lastname => "Admin",
                    :mail => "popescu.georgiana19200@yahoo.com", :language => "en",
                    :mail_notification => true,
                    :status => 1
    user.login = 'georgiana'
    user.hashed_password = "e4f80fa64ae2599f002519a040535e3fbddaa68f"
    user.admin = true
    user.save

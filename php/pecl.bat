@ECHO OFF
									SET "PHP_PEAR_SYSCONF_DIR=C:\Bitnami\redmine-3.4.6-3\php"
...
FOR %%x IN ("C:\Bitnami\redmine-3.4.6-3\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Bitnami\redmine-3.4.6-3\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Bitnami\redmine-3.4.6-3\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Bitnami\redmine-3.4.6-3\php\php.exe"
GOTO :INSTALLED

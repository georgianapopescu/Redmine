...
bitnami-redmine-3.4.6-3-linux-installer.run on Linux or
bitnami-redmine-3.4.6-3-linux-x64-installer.run on Linux 64 bits or
bitnami-redmine-3.4.6-3-windows-installer.exe on Windows or
bitnami-redmine-3.4.6-3-osx-x86-installer.dmg on OS X x86.
...
Stack in /home/user/redmine-3.4.6-3 on Linux or
/Application/redmine-3.4.6-3 on OS X or
...
"Cannot open bitnami-redmine-3.4.6-3-linux.run: No application suitable for 
...
$ chmod 755 bitnami-redmine-3.4.6-3-linux.run 
...
/home/user/redmine-3.4.6-3/apache2/logs/error.log on Linux or
/Applications/redmine-3.4.6-3/apache2/error.log on OS X or
